...
class PnDeliveryMessageNotFoundExceptionTest {

    /**
     * Method under test: {@link PnDeliveryMessageNotFoundException#PnDeliveryMessageNotFoundException(String, String, String)}
     */
    @Test
    void testConstructor() {
        PnDeliveryMessageNotFoundException actualException = new PnDeliveryMessageNotFoundException(
                "An error occurred",
                "The characteristics of someone or something",
                "An error occurred");

        assertEquals(404, actualException.getStatus());
        Problem problem = actualException.getProblem();
     ...
     */
    @Test
    void testConstructorWithSimpleValues() {
        PnDeliveryMessageNotFoundException actualException = new PnDeliveryMessageNotFoundException(
                "foo", "foo", "foo");

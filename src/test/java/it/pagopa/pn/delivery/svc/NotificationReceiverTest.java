...
class NotificationReceiverTest {
	...
	void successWritingNotificationWithPaymentsInformationWithDeliveryModeFee() throws PnIdConflictException {
		...
		// Given
		NewNotificationRequestV26 notification = newNotificationWithPaymentsDeliveryMode( );
	...
	void successWritingNotificationWithPaymentsInformationWithFlatFee() throws PnIdConflictException {
		...
		// Given
		NewNotificationRequestV26 notificationRequest = newNotificationRequest();
	...
	void throwsPnValidationExceptionForInvalidFormatNotification() {
		...
		// Given
		NewNotificationRequestV26 notification = NewNotificationRequestV26.builder()
	...
	void throwsPnValidationExceptionForInvalidFormatNotificationForMVP() {
		...
		// Given
		NewNotificationRequestV26 notification = newNotificationRequest();
	...
	void receiveInformalNotification_success() {
		...
		// Then
		assertNotNull(response);
		verify(pnExternalRegistriesClient).getOnePa(PAID);
	}
	...
	@Test
	void receiveInformalNotification_throwsExceptionWhenPaInfoIsNull() {
		// Given
		InformalNotificationRequestV1 request = new InformalNotificationRequestV1();
		request.setPaProtocolNumber("paProtocolNumber");
		request.setCampaignId("campaignId");
		when(pnExternalRegistriesClient.getOnePa(PAID)).thenReturn(null);
	...
	@Test
	void receiveInformalNotification_throwsExceptionWhenPaTaxIdIsNull() {
		// Given
		InformalNotificationRequestV1 request = new InformalNotificationRequestV1();
		request.setPaProtocolNumber("paProtocolNumber");
		request.setCampaignId("campaignId");
	...
	private NewNotificationRequestV26 newNotificationWithoutPayments( ) {
		return NewNotificationRequestV26.builder()
				...
				.subject("Subject 01")
				.physicalCommunicationType( NewNotificationRequestV26.PhysicalCommunicationTypeEnum.AR_REGISTERED_LETTER )
				.cancelledIun(IUN)
				.recipients( Collections.singletonList(
	...
	private NewNotificationRequestV26 newNotificationWithPaymentsDeliveryMode( ) {
		NewNotificationRequestV26 notification = newNotificationWithoutPayments( );

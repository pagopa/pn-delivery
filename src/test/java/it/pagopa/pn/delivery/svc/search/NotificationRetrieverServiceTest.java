...
class NotificationRetrieverServiceTest {
    ...
    void getNotificationWithTimelineInfoSuccess() {
        ...
        var tle = Collections.singletonList( new it.pagopa.pn.delivery.generated.openapi.msclient.deliverypush.v1.model.TimelineElementV23()
                //.iun( IUN )
                .elementId( "elementId" )
    ...
    void checkRefinementDateOraSolare() {
        // Given
        List<TimelineElementV23> timelineElementList = List.of( TimelineElementV23.builder()
                        .category( TimelineElementCategoryV23.REFINEMENT )
                        .timestamp( OffsetDateTime.parse( "2022-10-05T12:23:15.123456Z" ) )
                        .build(),
                TimelineElementV23.builder()
    ...
    void getNotificationWith2IUVBeforeTerms() {
        ...
        var tle = List.of( new it.pagopa.pn.delivery.generated.openapi.msclient.deliverypush.v1.model.TimelineElementV23()
                        .elementId( "elementId" )
                        .category( it.pagopa.pn.delivery.generated.openapi.msclient.deliverypush.v1.model.TimelineElementCategoryV23.REFINEMENT )
                        .timestamp(  OffsetDateTime.ofInstant( Instant.parse( "2022-01-11T00:00:00.00Z" ), ZoneOffset.UTC )),
                new it.pagopa.pn.delivery.generated.openapi.msclient.deliverypush.v1.model.TimelineElementV23()
    ...
    void checkIfNotificationIsNotCancelledWithNotificationNotCancelledTest() {
        ...
        deliveryPushResponse.setTimeline(List.of(
                new it.pagopa.pn.delivery.generated.openapi.msclient.deliverypush.v1.model.TimelineElementV23().category(it.pagopa.pn.delivery.generated.openapi.msclient.deliverypush.v1.model.TimelineElementCategoryV23.VALIDATE_NORMALIZE_ADDRESSES_REQUEST),
                new it.pagopa.pn.delivery.generated.openapi.msclient.deliverypush.v1.model.TimelineElementV23().category(it.pagopa.pn.delivery.generated.openapi.msclient.deliverypush.v1.model.TimelineElementCategoryV23.NORMALIZED_ADDRESS),
                new it.pagopa.pn.delivery.generated.openapi.msclient.deliverypush.v1.model.TimelineElementV23().category(it.pagopa.pn.delivery.generated.openapi.msclient.deliverypush.v1.model.TimelineElementCategoryV23.SENDER_ACK_CREATION_REQUEST),
                new it.pagopa.pn.delivery.generated.openapi.msclient.deliverypush.v1.model.TimelineElementV23().category(it.pagopa.pn.delivery.generated.openapi.msclient.deliverypush.v1.model.TimelineElementCategoryV23.REQUEST_ACCEPTED)
        ));
    ...
    void checkIfNotificationIsNotCancelledWithNotificationCancelledTest() {
        ...
        deliveryPushResponse.setTimeline(List.of(
                ...
                new it.pagopa.pn.delivery.generated.openapi.msclient.deliverypush.v1.model.TimelineElementV23().category(it.pagopa.pn.delivery.generated.openapi.msclient.deliverypush.v1.model.TimelineElementCategoryV23.SENDER_ACK_CREATION_REQUEST),
                new it.pagopa.pn.delivery.generated.openapi.msclient.deliverypush.v1.model.TimelineElementV23().category(it.pagopa.pn.delivery.generated.openapi.msclient.deliverypush.v1.model.TimelineElementCategoryV23.REQUEST_ACCEPTED),
                new it.pagopa.pn.delivery.generated.openapi.msclient.deliverypush.v1.model.TimelineElementV23().category(it.pagopa.pn.delivery.generated.openapi.msclient.deliverypush.v1.model.TimelineElementCategoryV23.NOTIFICATION_CANCELLATION_REQUEST)

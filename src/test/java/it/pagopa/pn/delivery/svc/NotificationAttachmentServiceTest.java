...
class NotificationAttachmentServiceTest {
    ...
    @Test
    void downloadDocumentWithRedirect_WithNumberOfPagesAsTag() {
        // Given
        String cxType = "PF";
        int docidx = 0;
    ...
    @Test
    void computeFileInfoGetUrlNull() {
        // Given
        InternalNotification notification = buildNotification(IUN, X_PAGOPA_PN_CX_ID);
        NotificationAttachmentService.FileDownloadIdentify fileDownloadIdentify =
                NotificationAttachmentService.FileDownloadIdentify.create(null, 0, "F24", null);
        ...
        Assertions.assertNull(fileInfos.getFileDownloadResponse().getDownload().getUrl());
        Assertions.assertEquals(BigDecimal.valueOf(1), fileInfos.getFileDownloadResponse().getDownload().getRetryAfter());
    }
    ...
    private FileDownloadResponse buildFileDownloadResponse(Map<String, List<String>> documentTags) {
    ...
    private FileDownloadResponse buildFileDownloadResponse() {
        return buildFileDownloadResponse(null);
    }

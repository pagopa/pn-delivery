...
class ValidationsTest {
    ...
    @Autowired
    private JacksonTester<NewNotificationRequestV26> jacksonTester;
    ...
    void newNotificationRequestValidationTest() throws IOException {
        String json = getJSON();
        NewNotificationRequestV26 newNotificationRequest = jacksonTester.parseObject(json);

        System.out.println(newNotificationRequest);

        Set<ConstraintViolation<NewNotificationRequestV26>> violations = validator.validate(newNotificationRequest);

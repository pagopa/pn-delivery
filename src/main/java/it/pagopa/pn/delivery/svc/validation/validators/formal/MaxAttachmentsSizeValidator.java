...
public class MaxAttachmentsSizeValidator implements FormalValidator<NotificaContext> {
    ...
    private void checkMaxAttachments(NotificaContext context, ArrayList<ProblemError> errors) {

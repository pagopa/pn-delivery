...
public class NotificationReceiverValidator {
    ...
    public NotificationReceiverValidator(Validator validator, MVPParameterConsumer mvpParameterConsumer, ValidateUtils validateUtils, PnDeliveryConfigs pnDeliveryConfigs,
                                         AgenziaEntrateApi agenziaEntrateApi, PhysicalAddressLookupParameterConsumer physicalAddressLookupParameter, InfoPaApi infoPaApi, PnExternalRegistriesClientImpl pnExternalRegistriesClient, FeatureFlagUtils featureFlagUtils) {

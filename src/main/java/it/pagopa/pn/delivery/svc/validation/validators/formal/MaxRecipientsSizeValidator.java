...
public class MaxRecipientsSizeValidator implements FormalValidator<NotificaContext> {
    ...
    private void checkMaxRecipients(NotificaContext context, ArrayList<ProblemError> errors) {

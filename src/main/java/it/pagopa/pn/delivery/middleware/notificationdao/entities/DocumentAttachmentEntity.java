...
public class DocumentAttachmentEntity {
    ...
    @Getter(onMethod=@__({@DynamoDbAttribute(COL_DIGESTS)})) private NotificationAttachmentDigestsEntity digests;
    @Getter(onMethod=@__({@DynamoDbAttribute(COL_REF)})) private NotificationAttachmentBodyRefEntity ref;

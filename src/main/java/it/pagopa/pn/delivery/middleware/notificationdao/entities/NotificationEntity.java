...
public class NotificationEntity {
    ...
    public static final String FIELD_SENDER_PRIORITY = "senderPriority";
    ...
    @Getter(onMethod=@__({@DynamoDbAttribute(FIELD_SENDER_PRIORITY)})) private Integer senderPriority;

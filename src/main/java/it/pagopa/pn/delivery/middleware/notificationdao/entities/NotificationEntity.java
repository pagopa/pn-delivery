...
public class NotificationEntity {
    ...
    @Getter(onMethod=@__({@DynamoDbAttribute(FIELD_PHYSICAL_COMMUNICATION_TYPE)})) private FullSentNotificationV26.PhysicalCommunicationTypeEnum physicalCommunicationType;

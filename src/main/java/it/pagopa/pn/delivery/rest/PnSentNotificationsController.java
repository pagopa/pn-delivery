...
public class PnSentNotificationsController implements SenderReadB2BApi,SenderReadWebApi {
    ...
    public ResponseEntity<NewNotificationRequestStatusResponseV21> getNotificationRequestStatusV21(String xPagopaPnUid, CxTypeAuthFleet xPagopaPnCxType, String xPagopaPnCxId, List<String> xPagopaPnCxGroups, String notificationRequestId, String paProtocolNumber, String idempotenceToken) {
        ...
        switch (lastStatus) {
            ...
            case REFUSED -> {
                ...
                response.setIun(null);
                Optional<TimelineElementV21> timelineElement = internalNotification.getTimeline().stream().filter(
                        tle -> TimelineElementCategoryV21.REQUEST_REFUSED.equals(tle.getCategory())).findFirst();
    ...
    private void setRefusedErrors(NewNotificationRequestStatusResponseV21 response, TimelineElementV21 timelineElement) {

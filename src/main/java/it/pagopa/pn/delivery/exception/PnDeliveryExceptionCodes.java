...
public class PnDeliveryExceptionCodes extends PnExceptionsCodes {
    ...
    public static final String ERROR_CODE_DELIVERY_INCOMPATIBLE_NOTIFICATION_STATUS = "PN_DELIVERY_INCOMPATIBLE_NOTIFICATION_STATUS";
    ...
    public static final String ERROR_CODE_DELIVERY_MESSAGE_NOT_FOUND = "PN_DELIVERY_MESSAGE_NOT_FOUND";
    ...
    public static final String ERROR_CODE_DELIVERY_PA_NOT_FOUND = "PN_DELIVERY_PA_NOT_FOUND";
    ...
    public static final String ERROR_CODE_DELIVERY_INVALID_MANDATE_COMMUNICATION_TYPE = "PN_DELIVERY_INVALID_MANDATE_COMMUNICATION_TYPE";
    ...
    public static final String ERROR_CODE_INFORMAL_PRIMARY_LANGUAGE_NOT_IT = "PN_DELIVERY_INFORMAL_PRIMARY_LANGUAGE_NOT_IT";
    public static final String ERROR_CODE_INFORMAL_INVALID_ADDITIONAL_LANGUAGE = "PN_DELIVERY_INFORMAL_INVALID_ADDITIONAL_LANGUAGE";
